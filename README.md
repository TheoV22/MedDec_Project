Here's the formatted version of your text for the README.md file:

---

# Explanation of `options.py`
...
# Explanation of `extract_texts.py`
...
# Explanation of `preprocess_phenos.py`
